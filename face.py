import cv2
import serial,time
face_cascade= cv2.CascadeClassifier("/Users/eashtmodi/Desktop/Python-Face Tracking/haarcascade_frontalface_default.xml")
cap=cv2.VideoCapture(0)
#fourcc= cv2.VideoWriter_fourcc(*'XVID')
ArduinoSerial=serial.Serial('/dev/cu.usbserial-14110',9600,timeout=0.1)
